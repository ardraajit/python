...
def calculateage():
    ...
    Label(text=f"{nameVlue.get()}Your age is {age}",font=30).place(x=300,y=500)
...
nameEntry=Entry(root,textvariable=nameVlue,width=30,bd=3,font=20)
...
Button(text="Calculator Age",font=20,bg="black",fg="white",width=11,height=2,command=calculateage).place(x=300,y=450)
